...
/* ── Bottom bar — 5 items, last is Profile ──────────────── */
const BOTTOM_NAV = [
  ...
  return (
    <UserCtx.Provider value={{ user, loading, refetchUser: fetchUser }}>
      ...
      >
        ...
        <aside
          className="hidden lg:flex fixed inset-y-0 left-0 z-50 w-72 flex-col"
          style={{
              ...
              return (
                ...
                >
                  <item.icon
                    ...
                    style={{
                      color: active ? "var(--accent-dim)" : "var(--t3)",
                    }}
                  />
                  {item.label}
                  {active && (
        ...
        <div className="flex-1 flex flex-col min-w-0 lg:ml-72">
          {/* Mobile top header */}
          <header
            className="lg:hidden sticky top-0 z-30 h-14 flex items-center justify-center backdrop-blur-md"
            style={{
          ...
          {/* Page content — extra bottom padding on mobile for the floating bar */}
          ...
          <div className="flex items-center justify-around h-16 px-2">
            {BOTTOM_NAV.map((item) => {
              ...
              return (
                ...
                >
                  <div
                    className="relative flex items-center justify-center w-10 h-8 transition-all"
                    style={{
                      borderRadius: "var(--r-field)",
                      background: active ? "var(--accent-tint)" : "transparent",
                    }}
