...
// Used for any custom category the user creates that doesn't have an icon of its own.
export const CAT_ICON_FALLBACK: Icon = Package;

// Curated icon choices offered when creating a custom category.
// Keys are stored on MonthBudget.categoryIcons and resolved back to a component via ICON_BY_KEY.
